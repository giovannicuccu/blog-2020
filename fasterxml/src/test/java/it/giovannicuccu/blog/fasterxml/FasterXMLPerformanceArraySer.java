...
public class FasterXMLPerformanceArraySer extends  PerformanceBaseClass{
    ...
    public FasterXMLPerformanceArraySer() {
...
/*
    ...
    public void fasterXMLStandard(BenchmarkConfig config, Blackhole bh) throws Exception {
        testMapperForJson(config.personeForJson, bh, objectMapper);
    }
*/
    ...
    public void fasterXMLStandardPersone(BenchmarkConfig config, Blackhole bh) throws Exception {
        testMapperPersoneForJson(config.personeForJsonForBenchmark, bh, objectMapper);
    }
...
/*    @Fork(value = 1, warmups = 1)
    ...
    public void fasterXMLStandardTypeReference(BenchmarkConfig config, Blackhole bh) throws Exception {
        testMapperWithTypeReferenceForJson(config.personeForJson, bh, objectMapper);
    }*/
